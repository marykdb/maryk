    ...
    private fun helpFor(command: String): List<String>? {
        return when (command) {
            ...
            "serve" -> listOf(
                ...
                "Usage:",
                "  serve rocksdb --dir <directory> [--host <host>] [--port <port>] [--bearer-token-env <name>|--bearer-token-file <path>|--bearer-token-stdin]",
                "  serve foundationdb --dir <directory> [--cluster <cluster file>] [--host <host>] [--port <port>] [--bearer-token-env <name>|--bearer-token-file <path>|--bearer-token-stdin]",
                "  serve --config <file>",
                "Notes:",

...
> {
    ...
    override fun readJson(reader: IsJsonLikeReader, context: DataModelContext?): PropertyDefinitions {
    ...
    IsPropertyDefinitionWrapper<PropertyDefinitions, PropertyDefinitions, DataModelContext, DO>
{
    ...
    override val toSerializable: ((PropertyDefinitions?, DataModelContext?) -> PropertyDefinitions?)? = null
    override val fromSerializable: ((PropertyDefinitions?) -> PropertyDefinitions?)? = null
    override val capturer: ((DataModelContext, PropertyDefinitions) -> Unit)? = null

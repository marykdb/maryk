...
data class Order internal constructor(
    ...
    internal companion object: QueryDataModel<Order, Properties>(
        ...
        override fun invoke(map: Values<Order, Properties>) = Order(
        ...
        override fun writeJson(map: Values<Order, Properties>, writer: IsJsonLikeWriter, context: DataModelPropertyContext?) {
            if (writer is YamlWriter) {
        ...
        override fun readJson(reader: IsJsonLikeReader, context: DataModelPropertyContext?): Values<Order, Properties> {

...
data class Aggregations internal constructor(
    ...
    internal companion object : SingleValueDataModel<Map<String, TypedValue<AggregationType, IsAggregationRequest>>, Map<String, IsAggregationRequest>, Aggregations, Properties, RequestContext>(

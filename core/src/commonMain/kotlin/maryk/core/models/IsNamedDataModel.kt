...
interface IsNamedDataModel<P: IsPropertyDefinitions>: IsDataModel<P> {
    ...
    companion object {
        internal fun <DM: IsNamedDataModel<*>> addName(definitions: ObjectPropertyDefinitions<DM>, getter: (DM) -> String): FlexBytesPropertyDefinitionWrapper<String, String, IsPropertyContext, StringDefinition, DM> {

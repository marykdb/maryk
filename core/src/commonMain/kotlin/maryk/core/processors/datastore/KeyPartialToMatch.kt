...
internal class KeyPartialToBeBigger(override val fromIndex: Int, val toBeSmaller: ByteArray, val inclusive: Boolean): IsKeyPartialToMatch {
...
internal class KeyPartialToBeSmaller(override val fromIndex: Int, val toBeBigger: ByteArray, val inclusive: Boolean): IsKeyPartialToMatch {

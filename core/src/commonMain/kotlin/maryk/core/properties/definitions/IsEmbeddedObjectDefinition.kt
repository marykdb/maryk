...
interface IsEmbeddedObjectDefinition<DO : Any, P : IsObjectPropertyDefinitions<DO>, out DM : AbstractObjectDataModel<DO, P, CXI, CX>, in CXI : IsPropertyContext, CX : IsPropertyContext> :

 ...
 */
interface IsValuePropertyDefinitionWrapper<T: Any, TO: Any, in CX:IsPropertyContext, in DO> : IsPropertyDefinitionWrapper<T, TO, CX, DO>, IsChangeableValueDefinition<T, CX>

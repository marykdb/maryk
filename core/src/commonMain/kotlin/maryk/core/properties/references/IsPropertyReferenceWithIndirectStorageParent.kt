 ...
 */
interface IsPropertyReferenceWithIndirectStorageParent<T : Any, out D : IsPropertyDefinition<T>, out P : IsPropertyReferenceForValues<*, *, *, *>, V : Any> : IsPropertyReference<T, D, V> {

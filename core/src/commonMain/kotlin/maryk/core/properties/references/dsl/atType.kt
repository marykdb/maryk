...
fun <E : TypeEnum<I>, I: Any, P : PropertyDefinitions, T : Any, R : IsPropertyReference<T, IsDefinitionWrapper<T, *, *, *>, *>> IsSubDefinition<TypedValue<E, *>, *>.atType(
    type: E,
...
fun <E: TypeEnum<I>, I: Any, P : PropertyDefinitions, T : Any, R : IsPropertyReference<T, IsDefinitionWrapper<T, *, *, *>, *>> IsSubDefinition<TypedValue<E, Any>, *>.atType(

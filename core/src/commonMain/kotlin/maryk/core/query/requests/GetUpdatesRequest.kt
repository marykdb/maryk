 ...
 */
fun <DM : IsRootModel> DM.getUpdates(
    vararg keys: Key<DM>,
    where: IsFilter? = null,
 ...
 */
data class GetUpdatesRequest<DM : IsRootModel> internal constructor(
    ...
    object Properties : ObjectPropertyDefinitions<GetUpdatesRequest<*>>() {
    ...
    companion object : QueryDataModel<GetUpdatesRequest<*>, Properties>(
        properties = Properties
    ) {
        override fun invoke(values: ObjectValues<GetUpdatesRequest<*>, Properties>) =
            GetUpdatesRequest(
                dataModel = values(1u),
                keys = values(2u),
                select = values(3u),

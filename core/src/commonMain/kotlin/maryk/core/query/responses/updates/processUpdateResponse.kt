...
fun <DM: IsRootValuesDataModel<P>, P: IsValuesPropertyDefinitions> processUpdateResponse(response: IsUpdateResponse<DM, P>, previousResults: List<ValuesWithMetaData<DM, P>>) =
    when (response) {

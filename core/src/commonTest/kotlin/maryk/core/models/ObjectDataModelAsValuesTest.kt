...
internal class ObjectDataModelAsValuesTest {
    ...
    fun convertToProtoBufAndBack() {
        ...
        bc.reserve(
            TestMarykObject.Serializer.calculateProtoBufLength(testExtendedObject, cache)
        )

        TestMarykObject.Serializer.writeProtoBuf(testExtendedObject, cache, bc::write)
        ...
        expect(testExtendedObject) { TestMarykObject.Serializer.readProtoBuf(bc.size, bc::read) }
    }

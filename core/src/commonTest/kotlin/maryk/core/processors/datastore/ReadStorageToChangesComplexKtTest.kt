...
private val complexValuesAsStorablesWithVersion = arrayOf(
    "09" to arrayOf(HLC(1234uL) to TypedValue(T3, Unit)),
    "091d" to arrayOf(HLC(1234uL) to Unit),
    "091d09" to arrayOf(HLC(1234uL) to "u3"),
    "091d16" to arrayOf(HLC(1234uL) to Unit),
    "091d1609" to arrayOf(HLC(1234uL) to "ue3"),
    "14" to arrayOf(HLC(1234uL) to 2),
    "14027631" to arrayOf(HLC(1234uL) to "a"),
    "1403763232" to arrayOf(HLC(1234uL) to "b"),
    "1c" to arrayOf(HLC(1234uL) to 2),
    "1c0400000001" to arrayOf(HLC(1234uL) to Unit),
    "1c040000000109" to arrayOf(HLC(1234uL) to "t1"),
    "1c0400000002" to arrayOf(HLC(1234uL) to Unit),
    "1c040000000209" to arrayOf(HLC(1234uL) to "t2"),
    "1c040000000216" to arrayOf(HLC(1234uL) to Unit),
    "1c04000000021609" to arrayOf(HLC(1234uL) to "te2"),
    "24" to arrayOf(HLC(1234uL) to 6),
    "240400000002" to arrayOf(HLC(1234uL) to TypedValue(T3, Unit)),
    "2404000000021d" to arrayOf(HLC(1234uL) to Unit),
    "2404000000021d09" to arrayOf(HLC(1234uL) to "m3"),
    "2404000000021d16" to arrayOf(HLC(1234uL) to Unit),
    "2404000000021d1609" to arrayOf(HLC(1234uL) to "me3"),
    "240400000005" to arrayOf(HLC(1234uL) to TypedValue(T1, "TEST")),
    "240400000007" to arrayOf(HLC(1234uL) to TypedValue(T4, Unit)),
    "2404000000072502" to arrayOf(HLC(1234uL) to 2),
    "240400000007250200000000" to arrayOf(HLC(1234uL) to "a"),
    "240400000007250200000001" to arrayOf(HLC(1234uL) to "b"),
    "240400000007250200000002" to arrayOf(HLC(1234uL) to null),
    "240400000008" to arrayOf(HLC(1234uL) to TypedValue(T5, Unit)),
    "2404000000082d03" to arrayOf(HLC(1234uL) to 2),
    "2404000000082d030163" to arrayOf(HLC(1234uL) to "c"),
    "2404000000082d030164" to arrayOf(HLC(1234uL) to "d"),
    "240400000009" to arrayOf(HLC(1234uL) to TypedValue(T6, Unit)),
    "2404000000093504" to arrayOf(HLC(1234uL) to 2),
    "24040000000935040400000005" to arrayOf(HLC(1234uL) to "e"),
    "24040000000935040400000006" to arrayOf(HLC(1234uL) to "f"),
    "24040000000a" to arrayOf(HLC(1234uL) to TypedValue(T7, Unit)),
    "24040000000a3d" to arrayOf(HLC(1234uL) to TypedValue(S3, Unit)),
    "24040000000a3d1d" to arrayOf(HLC(1234uL) to Unit),
    "24040000000a3d1d09" to arrayOf(HLC(1234uL) to "g"),
    "2c" to arrayOf(HLC(1234uL) to 1),
    "2c016102" to arrayOf(HLC(1234uL) to 2),
    "2c01610200000000" to arrayOf(HLC(1234uL) to "a1"),
    "2c01610200000001" to arrayOf(HLC(1234uL) to "a2"),
    "2c01610200000002" to arrayOf(HLC(1234uL) to null),
    "34" to arrayOf(HLC(1234uL) to 1),
    "34016203" to arrayOf(HLC(1234uL) to 2),
    "34016203026231" to arrayOf(HLC(1234uL) to "b1"),
    "34016203026232" to arrayOf(HLC(1234uL) to "b2"),
    "34016203026233" to arrayOf(HLC(1234uL) to null),
    "3c" to arrayOf(HLC(1234uL) to 1),
    "3c016304" to arrayOf(HLC(1234uL) to 1),
    "3c016304026331" to arrayOf(HLC(1234uL) to "c2")
)

...
internal fun createHardDeleteHistoryRowKey(keyBytes: ByteArray, version: ULong): ByteArray =
    combineToByteArray(keyBytes, (ULong.MAX_VALUE - version).toBigEndianBytes())

...
import maryk.datastore.shared.migration.MigrationStatus
...
import maryk.datastore.shared.migration.isMigrationNeeded
...
fun checkModelIfMigrationIsNeeded(
    ...
    return when {
        dataModel.version != version || !onlyCheckVersion -> {
            ...
            val storedDataModel = Model.readProtoBuf(modelBytes.size, { modelBytes[readIndex++] }, context).toDataObject()

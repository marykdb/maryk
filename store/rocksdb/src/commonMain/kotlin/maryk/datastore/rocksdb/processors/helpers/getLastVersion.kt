 ...
 */
internal fun <DM: IsRootDataModel<*>> getLastVersion(transaction: Transaction, columnFamilies: TableColumnFamilies, readOptions: ReadOptions, key: Key<DM>): ULong {
    key.bytes.copyInto(recyclableByteArray)
    recyclableByteArray[key.bytes.size] = LAST_VERSION_INDICATOR

    val valueLength = transaction.get(columnFamilies.table, readOptions, recyclableByteArray, 0, key.size + 1, recyclableByteArray2)

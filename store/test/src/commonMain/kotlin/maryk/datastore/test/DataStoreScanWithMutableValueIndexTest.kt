...
class DataStoreScanWithMutableValueIndexTest(
    ...
    private val objects = arrayOf(
        ModelV2ExtraIndex.create { value with "ha1"; newNumber with 5 },
        ModelV2ExtraIndex.create { value with "ha2"; newNumber with 2 },
        ModelV2ExtraIndex.create { value with "ha3"; newNumber with 7 },
        ModelV2ExtraIndex.create { value with "ha4"; newNumber with 1 },
    )

...
3. Move to IndexedDB for browser-local persistence, RocksDB for embedded persistence, or FoundationDB for server-side storage.
4. Inspect RocksDB, FoundationDB, or Remote records with the CLI or App.
...
maryk --connect rocksdb --dir ./data --exec "get Client AbCdEf123 save ./exports"
```
...
$ maryk --connect rocksdb --dir ./data --exec "get Client AbCdEf123 save ./exports"
Saved to ./exports/AbCdEf123.yaml
```
